"""Typed error class for the Locavello SDK."""
...
class LocavelloError(Exception):
    """Raised when a Locavello API call fails.
    ...
    def __repr__(self) -> str:
        return (
            f"LocavelloError(status={self.status}, code={self.code!r}, "
