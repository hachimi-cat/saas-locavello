 ...
 * (Plugipay-HMAC / Serront-Signature / …, here Locavello flavored):
 *
 *   Locavello-Signature: t=<unix>,v1=<hex hmac-sha256(secret, t + "." + body)>
 *
...
export const SIGNATURE_HEADER = 'Locavello-Signature';
